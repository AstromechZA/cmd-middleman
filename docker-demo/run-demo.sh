...
export GOOS=linux
export GOARCH=amd64
go build -i -v -o "$DIR/client-container/rpc-cmd-client" github.com/AstromechZA/middleman/client
go build -i -v -o "$DIR/server-container/rpc-cmd-server" github.com/AstromechZA/middleman/server
